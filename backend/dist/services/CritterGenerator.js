...
exports.CritterGenerator = void 0;
const SPRITES = {
    meme: [
...
class CritterGenerator {
    ...
    generateBio(species, personality, tokenName) {
        const bios = {
            chaotic: [
    ...
    async generateAvatar(species, personality) {
...
exports.CritterGenerator = CritterGenerator;
